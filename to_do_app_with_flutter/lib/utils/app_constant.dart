...
const String FACEBOOK_URL = "https://www.facebook.com/mouhamed.farhaoui";
const String GITHUB_URL = "https://github.com/farhaouiMed";
const String PROJECT_URL = "";
const String ISSUE_URL = "";
const String README_URL =
    "";
const String EMAIL_URL =
    "mailto:<mohamed.farhaoui@etudiant-enit.utm.tn>?subject=WhatTodo%20Query&body=Hi";
